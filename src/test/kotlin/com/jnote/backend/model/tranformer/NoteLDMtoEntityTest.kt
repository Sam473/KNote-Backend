...
internal class NoteLDMtoEntityTest {

    @Test
    fun willReturnEntityWithCorrectProperties() {
        val noteLDMtoEntity = NoteLDMtoEntity()
        val note: INote = Note.Builder()
            ...
            .build()
        val expected = NoteEntity(TITLE, BODY, DATE_CREATED, DATE_LAST_MODIFIED)

        assertThat(noteLDMtoEntity.transform(note))
